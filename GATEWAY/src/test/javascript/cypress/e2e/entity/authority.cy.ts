...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'acce001e-ec88-4705-8cf5-8347f4d6fd5b' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('590b0696-d363-4794-9045-de9ea2e6d234');
      cy.get(`[data-cy="name"]`).should('have.value', '590b0696-d363-4794-9045-de9ea2e6d234');
